...
planetname='kelt20b'
h5f_specharpsn=h5py.File(str(planetname)+'-trans-kurucz-detected-fc_all.h5', 'w')
h5f_speccarmenes=h5py.File(str(planetname)+'-trans-kurucz-detected-fc_all-carmenes.h5', 'w')

for t in tqdm(range(2000,4600,500)):
	...
	tpfile.close()
	print (len(nlist))
	name=np.array(['Ca_I','Ca_II','Fe_I','Fe_II','Mg_I','Na_I'])
