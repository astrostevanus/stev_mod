...
from ir import c, k, amu, C2
from molecules import get_molec_data, molecules, mainMolecules
from aeiou import parse_comments, readFileHeader, open_outFile
from struc_array import loadStrucArray, strucArrayAddField
from cgsUnits import unitConversion, cgs
from pairTypes import Interval, PairOfFloats, PairOfInts
...
kuruczdir='/Users/snugroho/japan/py4/data/lines/'
...
def voigt_parameters (lines, molData, pressure=1013.25e3, temperature=296.0, verbose=False):
	...
	if molData["molecule"]=="Ag_I" or molData["molecule"]=="Ag_II" or molData["molecule"]=="Al_I" or molData["molecule"]=="Al_II" or molData["molecule"]=="Ar_I" or molData["molecule"]=="Ar_II" or molData["molecule"]=="As_I" or molData["molecule"]=="B_I" or molData["molecule"]=="B_II" or molData["molecule"]=="Ba_I" or molData["molecule"]=="Ba_II" or molData["molecule"]=="Be_I" or molData["molecule"]=="Be_II" or molData["molecule"]=="C_I" or molData["molecule"]=="C_II" or molData["molecule"]=="Ca_I" or molData["molecule"]=="Ca_II" or molData["molecule"]=="Cd_I" or molData["molecule"]=="Cd_II" or molData["molecule"]=="Ce_I" or molData["molecule"]=="Ce_II" or molData["molecule"]=="Cl_I" or molData["molecule"]=="Cl_II" or molData["molecule"]=="Co_I" or molData["molecule"]=="Co_II" or molData["molecule"]=="Cr_I" or molData["molecule"]=="Cr_II" or molData["molecule"]=="Cs_I" or molData["molecule"]=="Cu_I" or molData["molecule"]=="Cu_II" or molData["molecule"]=="Dy_I" or molData["molecule"]=="Dy_II" or molData["molecule"]=="Er_I" or molData["molecule"]=="Er_II" or molData["molecule"]=="Eu_I" or molData["molecule"]=="Eu_II" or molData["molecule"]=="F_I" or molData["molecule"]=="F_II" or molData["molecule"]=="Fe_I" or molData["molecule"]=="Fe_II" or molData["molecule"]=="Ga_I" or molData["molecule"]=="Ga_II" or molData["molecule"]=="Gd_I" or molData["molecule"]=="Gd_II" or molData["molecule"]=="Ge_I" or molData["molecule"]=="Ge_II" or molData["molecule"]=="Hf_I" or molData["molecule"]=="Hf_II" or molData["molecule"]=="Ho_I" or molData["molecule"]=="Ho_II" or molData["molecule"]=="In_I" or molData["molecule"]=="In_II" or molData["molecule"]=="Ir_I" or molData["molecule"]=="Ir_II" or molData["molecule"]=="K_I" or molData["molecule"]=="K_II" or molData["molecule"]=="La_I" or molData["molecule"]=="La_II" or molData["molecule"]=="Li_I" or molData["molecule"]=="Li_II" or molData["molecule"]=="Lu_I" or molData["molecule"]=="Lu_II" or molData["molecule"]=="Mg_I" or molData["molecule"]=="Mg_II" or molData["molecule"]=="Mn_I" or molData["molecule"]=="Mn_II" or molData["molecule"]=="Mo_I" or molData["molecule"]=="Mo_II" or molData["molecule"]=="N_I" or molData["molecule"]=="N_II" or molData["molecule"]=="Na_I" or molData["molecule"]=="Na_II" or molData["molecule"]=="Nb_I" or molData["molecule"]=="Nb_II" or molData["molecule"]=="Nd_I" or molData["molecule"]=="Nd_II" or molData["molecule"]=="Ne_I" or molData["molecule"]=="Ne_II" or molData["molecule"]=="Ni_I" or molData["molecule"]=="Ni_II" or molData["molecule"]=="O_I" or molData["molecule"]=="O_II" or molData["molecule"]=="Os_I" or molData["molecule"]=="Os_II" or molData["molecule"]=="P_I" or molData["molecule"]=="P_II" or molData["molecule"]=="Pd_I" or molData["molecule"]=="Pd_II" or molData["molecule"]=="Pr_I" or molData["molecule"]=="Pr_II" or molData["molecule"]=="Pt_I" or molData["molecule"]=="Rb_I" or molData["molecule"]=="Re_I" or molData["molecule"]=="Re_II" or molData["molecule"]=="Rh_I" or molData["molecule"]=="Rh_II" or molData["molecule"]=="Ru_I" or molData["molecule"]=="Ru_II" or molData["molecule"]=="S_I" or molData["molecule"]=="S_II" or molData["molecule"]=="Sb_I" or molData["molecule"]=="Sc_I" or molData["molecule"]=="Sc_II" or molData["molecule"]=="Se_I" or molData["molecule"]=="Si_I" or molData["molecule"]=="Si_II" or molData["molecule"]=="Sm_I" or molData["molecule"]=="Sm_II" or molData["molecule"]=="Sn_I" or molData["molecule"]=="Sn_II" or molData["molecule"]=="Sr_I" or molData["molecule"]=="Sr_II" or molData["molecule"]=="Ta_I" or molData["molecule"]=="Ta_II" or molData["molecule"]=="Tb_I" or molData["molecule"]=="Tb_II" or molData["molecule"]=="Tc_I" or molData["molecule"]=="Tc_II" or molData["molecule"]=="Te_I" or molData["molecule"]=="Ti_I" or molData["molecule"]=="Ti_II" or molData["molecule"]=="Tm_I" or molData["molecule"]=="Tm_II" or molData["molecule"]=="V_I" or molData["molecule"]=="V_II" or molData["molecule"]=="W_I" or molData["molecule"]=="W_II" or molData["molecule"]=="Y_I" or molData["molecule"]=="Y_II" or molData["molecule"]=="Yb_I" or molData["molecule"]=="Yb_II" or molData["molecule"]=="Zn_I" or molData["molecule"]=="Zn_II" or molData["molecule"]=="Zr_I" or molData["molecule"]=="Zr_II":
	
		print ("--------             WARNING              ----------")
		print ("YOU ARE USING Kurucz version modified by S. K. Nugroho")
		print ("--------   it means no warranty !!!!!   ------------")
		elem=molData["molecule"]
		Sh0=lines['S']
		nui=lines['E']
		hatnu=lines['v']
		T0=lines.t
		P0=lines.p
		gammaN=lines['a']
		#print (molData["molecule"])
		from scipy import interpolate
		T_,Q_=np.loadtxt(str(kuruczdir)+str(molData["molecule"])+'.pf',unpack=True)
		Q_inter = interpolate.interp1d(T_,Q_,kind="cubic")
		QT= Q_inter(temperature)
		QT0= Q_inter(T0)
		
		amu=molData["mass"]
		
		import line_strength as ls
		strengths=ls.Sh0toSh(Sh0,nui,hatnu,QT,temperature,QT0,T0)
		
		gammaD=hatnu*np.sqrt(2.0*ln2*k_cgs*temperature/(mp_cgs*amu*c_cgs*c_cgs)) 
		gammaL=10**gammaN/(4*np.pi*c_cgs)
		print ("position, gammaD, gammaL, T, p")
		print (np.mean(hatnu), np.mean(gammaD),np.mean(gammaL), np.mean(temperature), np.mean(pressure))
